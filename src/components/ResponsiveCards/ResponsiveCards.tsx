        ...
        <div className="ag-courses_item">
          <a href="#" className="ag-courses-item_link">
            ...
            <div className="ag-courses-item_title">
              ...
              <p className="title-color">
                UX refers to user experience, while UI stands for user interface
              </p>
            </div>
        ...
        <div className="ag-courses_item">
          <a href="#" className="ag-courses-item_link">
            ...
            <div className="ag-courses-item_title">
              Motion Design
              <p className="title-color">
                Motion Graphics is animated graphic design, whereas Visual
                Effects combines existing footage with computer generated
                imagery to create realistic scenes.
              </p>
            </div>
